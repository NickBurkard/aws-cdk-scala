...
object StandardNpmSynthOptions {
  ...
  ): software.amazon.awscdk.pipelines.StandardNpmSynthOptions =
    (new software.amazon.awscdk.pipelines.StandardNpmSynthOptions.Builder)
