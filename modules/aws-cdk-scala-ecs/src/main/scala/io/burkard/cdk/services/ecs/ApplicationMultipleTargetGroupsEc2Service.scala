...
object ApplicationMultipleTargetGroupsEc2Service {
  ...
  )(implicit stackCtx: software.amazon.awscdk.Stack): software.amazon.awscdk.services.ecs.patterns.ApplicationMultipleTargetGroupsEc2Service =
