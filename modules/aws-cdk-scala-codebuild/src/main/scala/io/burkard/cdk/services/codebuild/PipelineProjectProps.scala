...
object PipelineProjectProps {
  ...
  ): software.amazon.awscdk.services.codebuild.PipelineProjectProps =
    (new software.amazon.awscdk.services.codebuild.PipelineProjectProps.Builder)
