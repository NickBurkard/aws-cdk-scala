...
object AthenaStopQueryExecution {
  ...
  )(implicit stackCtx: software.amazon.awscdk.Stack): software.amazon.awscdk.services.stepfunctions.tasks.AthenaStopQueryExecution =
