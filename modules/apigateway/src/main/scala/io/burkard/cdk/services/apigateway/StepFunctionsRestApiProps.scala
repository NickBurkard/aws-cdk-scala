...
object StepFunctionsRestApiProps {
  ...
  ): software.amazon.awscdk.services.apigateway.StepFunctionsRestApiProps =
    (new software.amazon.awscdk.services.apigateway.StepFunctionsRestApiProps.Builder)
