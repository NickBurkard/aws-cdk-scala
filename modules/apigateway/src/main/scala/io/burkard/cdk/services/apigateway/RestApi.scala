...
object RestApi {
  ...
  )(implicit stackCtx: software.amazon.awscdk.Stack): software.amazon.awscdk.services.apigateway.RestApi =
    software.amazon.awscdk.services.apigateway.RestApi.Builder
