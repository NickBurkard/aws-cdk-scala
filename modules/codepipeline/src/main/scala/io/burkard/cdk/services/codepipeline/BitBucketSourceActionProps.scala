...
object BitBucketSourceActionProps {
  ...
  ): software.amazon.awscdk.services.codepipeline.actions.BitBucketSourceActionProps =
    (new software.amazon.awscdk.services.codepipeline.actions.BitBucketSourceActionProps.Builder)
