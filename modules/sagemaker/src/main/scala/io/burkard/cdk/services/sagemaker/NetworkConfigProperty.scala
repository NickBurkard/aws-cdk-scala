...
object NetworkConfigProperty {
  ...
  def apply(
    ...
    vpcConfig: Option[software.amazon.awscdk.services.sagemaker.CfnDataQualityJobDefinition.VpcConfigProperty] = None
  ): software.amazon.awscdk.services.sagemaker.CfnDataQualityJobDefinition.NetworkConfigProperty =
    (new software.amazon.awscdk.services.sagemaker.CfnDataQualityJobDefinition.NetworkConfigProperty.Builder)
