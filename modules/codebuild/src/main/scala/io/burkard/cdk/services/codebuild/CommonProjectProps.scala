...
object CommonProjectProps {
  ...
  ): software.amazon.awscdk.services.codebuild.CommonProjectProps =
    (new software.amazon.awscdk.services.codebuild.CommonProjectProps.Builder)
