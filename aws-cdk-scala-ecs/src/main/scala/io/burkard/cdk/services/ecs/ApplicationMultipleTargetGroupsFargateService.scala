...
object ApplicationMultipleTargetGroupsFargateService {
  ...
  )(implicit stackCtx: software.amazon.awscdk.Stack): software.amazon.awscdk.services.ecs.patterns.ApplicationMultipleTargetGroupsFargateService =
