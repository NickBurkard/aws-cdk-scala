...
object DropSpamReceiptRuleProps {
  ...
  ): software.amazon.awscdk.services.ses.DropSpamReceiptRuleProps =
    (new software.amazon.awscdk.services.ses.DropSpamReceiptRuleProps.Builder)
